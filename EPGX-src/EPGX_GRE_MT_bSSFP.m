function [F0,Fn,Zn,F] = EPGX_GRE_MT_bSSFP(theta,phi,B1SqrdTau,TR,T1x,T2a,f,ka,G,varargin)
...
%   Modifed the prep pulse to serve as the alpha/2 rampup pulse for bSSFP
%   (to eliminate the ocillations during the transient phase)
%   Chong Duan 2018-01-11
...
% add the Hargreaves's simulation code
addpath(genpath('C:\ChongDuan\1_Dynamic Relaxometry\BlochSimulation\Brian Hargreaves_Stanford'));
